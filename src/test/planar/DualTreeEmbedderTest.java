...
public class DualTreeEmbedderTest {
    ...
    public void fusedHexagonPair() {
        IntGraph g = new IntGraph("0:1,0:5,1:2,2:3,3:4,4:5,4:6,5:9,6:7,7:8,8:9");
        test(g);
    }
    
    @Test
    public void fusane6_0_Test() {
        IntGraph g = new IntGraph("0:1,0:5,0:6,10:11,11:12,12:13,14:15,15:16,16:17,18:19,18:22," +
    ...
    public void fusane6_1_Test() {
        IntGraph g = new IntGraph("0:1,0:5,0:6,1:2,1:9,2:3,3:4,4:5,4:18,5:21,6:7,6:10,7:8,7:13,8:9,8:14," +
    ...
    public void fusane6_2_Test() {
        IntGraph g = new IntGraph("0:1,0:5,0:6,1:2,1:9,2:3,3:4,3:18,4:5,4:21,6:7,6:10,7:8,7:13,8:9,8:14," +
